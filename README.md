...
<h4>This is the screen that will appear when the game initially starts:</h4>
<img src = "Starting_Screen.png" width = "40%">


<h4>This is the screen that appears when the user selects the right or wrong answer:</h4>
<img src = "Right_Wrong_Screen.png" width = "40%">

<h4>This is the statistics screen that shows the player’s longest streak and results of the last 3 questions:</h4>
<img src = "Stats_Screen.png" width = "40%">
